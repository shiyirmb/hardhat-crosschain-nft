...
// 使用CCIP进行跨链，参考：https://docs.chain.link/ccip/tutorials/send-arbitrary-data#tutorial
// 跨链过程：
// 通证被锁在源链上的池子中，然后它的包装/合成/衍生资产在目的链上被铸造（mint）
...
/// @title - A simple NFTPoolLockAndRelease contract for sending/receiving string data across chains.
        ...
        return
            Client.EVM2AnyMessage({
                ...
                extraArgs: Client._argsToBytes(
                    ...
                    Client.EVMExtraArgsV1({ gasLimit: 200_000 }) // 文档上为V2 单元测试被卡住 看源码后应该修改为V1
                ),
